...
system_prompt = (
    ...
    " Всегда переводи результаты на русский язык полностью, включая все детали."
    ""
    "Для каждой подсети составь краткий отчёт по трём категориям на русском языке:\n"
    "🛑 Проблемы\n"
    "🔄 Обновления\n"
    "🚀 Релизы / Планы\n"
    "\nЕсли по категории нет информации — поставь прочерк.\n"
